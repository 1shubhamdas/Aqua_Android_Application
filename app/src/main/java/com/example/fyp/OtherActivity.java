...
public class OtherActivity extends AppCompatActivity {
    ...
    public Uri addUri;
    DatabaseReference mOtherDatabase;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(addUri==null){
                    Toast.makeText(OtherActivity.this,"Please upload an Image",Toast.LENGTH_SHORT).show();
                }
                if(TextUtils.isEmpty(id))
                {
                    Toast.makeText(OtherActivity.this,"Please upload an Id",Toast.LENGTH_SHORT).show();
                }
                else if(TextUtils.isEmpty(title)){
                    Toast.makeText(OtherActivity.this,"Please upload a Title",Toast.LENGTH_SHORT).show();
                }
                else if(TextUtils.isEmpty(description)){
                    Toast.makeText(OtherActivity.this,"Please upload a Description",Toast.LENGTH_SHORT).show();
                }
                else{
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        aquareference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                                ...
                                mOtherDatabase = FirebaseDatabase.getInstance ().getReference ("mOtherDatabase").child(id);
                                mOtherDatabase.setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void> () {
                                    @Override
