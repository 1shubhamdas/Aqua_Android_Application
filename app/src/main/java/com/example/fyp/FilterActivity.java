...
public class FilterActivity extends AppCompatActivity {
    ...
    public Uri addUri;
    DatabaseReference mFilterDatabase;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(addUri==null){
                    Toast.makeText(FilterActivity.this,"Please upload an Image",Toast.LENGTH_SHORT).show();
                }
                if(TextUtils.isEmpty(id))
                {
                    Toast.makeText(FilterActivity.this,"Please upload an Id",Toast.LENGTH_SHORT).show();
                }
                else if(TextUtils.isEmpty(title)){
                    Toast.makeText(FilterActivity.this,"Please upload a Title",Toast.LENGTH_SHORT).show();
                }
                else if(TextUtils.isEmpty(description)){
                    Toast.makeText(FilterActivity.this,"Please upload a Description",Toast.LENGTH_SHORT).show();
                }
                else{
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        aquareference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                                ...
                                mFilterDatabase = FirebaseDatabase.getInstance ().getReference ("mFilterDatabase").child(id);
                                mFilterDatabase.setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void> () {
                                    @Override
