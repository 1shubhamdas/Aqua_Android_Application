...
public class TankActivity extends AppCompatActivity {
    ...
    public Uri addUri;
    DatabaseReference mTankDatabase;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(addUri==null){
                    Toast.makeText(TankActivity.this,"Please upload an Image",Toast.LENGTH_SHORT).show();
                }
                if(TextUtils.isEmpty(id))
                {
                    Toast.makeText(TankActivity.this,"Please upload an Id",Toast.LENGTH_SHORT).show();
                }
                else if(TextUtils.isEmpty(title)){
                    Toast.makeText(TankActivity.this,"Please upload a Title",Toast.LENGTH_SHORT).show();
                }
                else if(TextUtils.isEmpty(description)){
                    Toast.makeText(TankActivity.this,"Please upload a Description",Toast.LENGTH_SHORT).show();
                }
                else{
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        aquareference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                                ...
                                mTankDatabase = FirebaseDatabase.getInstance ().getReference ("mTankDatabase").child(id);
                                mTankDatabase.setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void> () {
                                    @Override
